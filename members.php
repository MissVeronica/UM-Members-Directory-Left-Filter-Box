...
<div class="um <?php echo esc_attr( $this->get_class( $mode ) ); ?> um-<?php echo esc_attr( substr( md5( $form_id ), 10, 5 ) ); ?>"
	 ...
	 data-sorting="<?php echo esc_attr( $sort_from_url ) ?>" style="display: table-row;">

	
		<div class="um-member-directory-header um-form" style="display: table-cell;width:20%;padding-right:10px;text-align: center;">

			<?php if ( $search && $show_search ) { ?>
				
				<div class="um-member-directory-search-line um-member-directory-search-row">
					<label>
		...
		<div style="display: table-cell;width:80%;">
			...
			<div class="um-members-wrapper">
				...
				<?php //send $args variable to the templates
				$args['args'] = $args;
				...
				<?php UM()->get_template( 'members-header.php', '', $args, true ); ?>
				...
				<?php UM()->get_template( 'members-pagination.php', '', $args, true ); ?>
